...
public class ExternalLoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTestBtn = (Button) findViewById(R.id.activity_external_login_testBtn);
        mWebView = (WebView) findViewById(R.id.activity_external_login_webView);

        mTestBtn.setOnClickListener(this);
        mTestBtn.setText("Log in with: " + getIntent().getStringExtra(EXTRA_EXTERNAL_SERVICE));
    }
